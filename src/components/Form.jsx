...
const Form = () => {
  return (  
    <div id="form" className='overflow-y-auto my-12 flex flex-col justify-center items-center'>
        ...
        <h2 class="text-lg font-semibold  capitalize text-gray-300">Section - Hero</h2>
        <form>
        ...
        <section class="max-w-4xl p-6 my-10 mx-auto rounded-lg border border-gray-300 shadow-md bg-gray-800">
        <h2 class="text-lg font-semibold  capitalize text-gray-300">Section - About Us</h2>
        <form>
            <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                <div>
    ...
    <section class="max-w-4xl p-6 my-10 mx-auto rounded-lg border border-gray-300 shadow-md bg-gray-800">
        <h2 class="text-lg font-semibold  capitalize text-gray-300">Section - Grid</h2>
        <form>
            <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                <div>
                    <label class="text-gray-200" for="name">Company name</label>
